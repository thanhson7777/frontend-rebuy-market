    ...
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ maxWidth: 500, mx: 'auto' }}>
      <Stack spacing={1} mb={4} textAlign="center">
        <Box sx={{ display: 'flex', justifyContent: 'center', mb: 1 }}>
          <AdminPanelSettingsIcon sx={{ fontSize: 48, color: 'primary.main', opacity: 0.8 }} />
        </Box>
        <Typography variant="h6" fontWeight="800">Cài đặt bảo mật Admin</Typography>
        <Typography variant="body2" color="text.secondary">
          Bạn nên sử dụng mật khẩu mạnh bao gồm chữ cái, số và ký tự đặc biệt để bảo vệ tài khoản quản trị.
        </Typography>
      </Stack>
